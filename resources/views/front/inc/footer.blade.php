            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        <h3 class="heading-title">{{ $setting ? $setting->site_name : "My Blog"}}</h3>
            ...
            <div class="contacts">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{ $setting ? $setting->contact_number : "064/02-09-601"}}</a>
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{ $setting ? $setting->contact_email : "dejanstankovicle@gmail.com"}}</a>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">{{ $setting ? $setting->address : "Leskovac"}}</a>
                            <p class="sub-title">Serbia</p>
                        </div>
                    </div>
                </div>
